...
public final class CrashReportDialog extends Activity {
    ...
    /* renamed from: org.acra.CrashReportDialog.1 */
    ...
    /* renamed from: org.acra.CrashReportDialog.2 */
    ...
    /* renamed from: org.acra.CrashReportDialog.3 */
    class C00323 implements Runnable {
        final /* synthetic */ ScrollView val$scroll;

        C00323(ScrollView scrollView) {
            this.val$scroll = scrollView;
        }

        public void run() {
            this.val$scroll.scrollTo(0, 0);
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yes.setOnClickListener(new C00301());
        buttons.addView(yes, new LinearLayout.LayoutParams(-1, -2, 1.0f));
        Button no = new Button(this);
        no.setText(17039369);
        no.setOnClickListener(new C00312());
