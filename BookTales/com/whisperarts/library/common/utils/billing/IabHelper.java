package com.whisperarts.library.common.utils.billing;
...
public class IabHelper {
    ...
    /* renamed from: com.whisperarts.library.common.utils.billing.IabHelper.1 */
    class C00061 implements ServiceConnection {
        private final /* synthetic */ OnIabSetupFinishedListener val$listener;

        C00061(OnIabSetupFinishedListener onIabSetupFinishedListener) {
    ...
    /* renamed from: com.whisperarts.library.common.utils.billing.IabHelper.2 */
    class C00082 implements Runnable {
        ...
        /* renamed from: com.whisperarts.library.common.utils.billing.IabHelper.2.1 */
        class C00071 implements Runnable {
            ...
            C00071(QueryInventoryFinishedListener queryInventoryFinishedListener, IabResult iabResult, Inventory inventory) {
        ...
        C00082(boolean z, List list, QueryInventoryFinishedListener queryInventoryFinishedListener, Handler handler) {
        ...
        public void run() {
            ...
            if (!IabHelper.this.mDisposed && this.val$listener != null) {
                this.val$handler.post(new C00071(this.val$listener, result_f, inv_f));
            }
        }
    }

    /* renamed from: com.whisperarts.library.common.utils.billing.IabHelper.3 */
    class C00113 implements Runnable {
        ...
        /* renamed from: com.whisperarts.library.common.utils.billing.IabHelper.3.1 */
        class C00091 implements Runnable {
            private final /* synthetic */ List val$purchases;
            private final /* synthetic */ List val$results;
            private final /* synthetic */ OnConsumeFinishedListener val$singleListener;

            C00091(OnConsumeFinishedListener onConsumeFinishedListener, List list, List list2) {
        ...
        /* renamed from: com.whisperarts.library.common.utils.billing.IabHelper.3.2 */
        class C00102 implements Runnable {
            private final /* synthetic */ OnConsumeMultiFinishedListener val$multiListener;
            private final /* synthetic */ List val$purchases;
            private final /* synthetic */ List val$results;

            C00102(OnConsumeMultiFinishedListener onConsumeMultiFinishedListener, List list, List list2) {
        ...
        C00113(List list, OnConsumeFinishedListener onConsumeFinishedListener, Handler handler, OnConsumeMultiFinishedListener onConsumeMultiFinishedListener) {
            this.val$purchases = list;
            this.val$singleListener = onConsumeFinishedListener;
            this.val$handler = handler;
            this.val$multiListener = onConsumeMultiFinishedListener;
        ...
        public void run() {
            ...
            if (!(IabHelper.this.mDisposed || this.val$singleListener == null)) {
                this.val$handler.post(new C00091(this.val$singleListener, this.val$purchases, results));
            }
            if (!IabHelper.this.mDisposed && this.val$multiListener != null) {
                this.val$handler.post(new C00102(this.val$multiListener, this.val$purchases, results));
            }
        }
    }
    ...
    public IabHelper(Context ctx, String base64PublicKey) {
        ...
        this.mAsyncOperation = ACRAConstants.DEFAULT_STRING_VALUE;
    ...
    public void startSetup(OnIabSetupFinishedListener listener) {
        ...
        this.mServiceConn = new C00061(listener);
        Intent serviceIntent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
        serviceIntent.setPackage("com.android.vending");
        List<ResolveInfo> queryIntentServices = this.mContext.getPackageManager().queryIntentServices(serviceIntent, BILLING_RESPONSE_RESULT_OK);
    ...
    public void launchPurchaseFlow(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener) {
        launchPurchaseFlow(act, sku, requestCode, listener, ACRAConstants.DEFAULT_STRING_VALUE);
    }
    ...
    public void launchSubscriptionPurchaseFlow(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener) {
        launchSubscriptionPurchaseFlow(act, sku, requestCode, listener, ACRAConstants.DEFAULT_STRING_VALUE);
    }
    ...
    public void queryInventoryAsync(boolean querySkuDetails, List<String> moreSkus, QueryInventoryFinishedListener listener) {
        ...
        new Thread(new C00082(querySkuDetails, moreSkus, listener, handler)).start();
    }
    ...
    void consume(Purchase itemInfo) throws IabException {
        ...
        if (itemInfo.mItemType.equals(ITEM_TYPE_INAPP)) {
            try {
                ...
                if (token == null || token.equals(ACRAConstants.DEFAULT_STRING_VALUE)) {
    ...
    void consumeAsyncInternal(List<Purchase> purchases, OnConsumeFinishedListener singleListener, OnConsumeMultiFinishedListener multiListener) {
        ...
        new Thread(new C00113(purchases, singleListener, handler, multiListener)).start();
    }
