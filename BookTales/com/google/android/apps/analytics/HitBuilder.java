...
class HitBuilder {
    ...
    private static String constructTransactionRequestPath(Event event, Referrer referrer) {
        ...
        if (transaction != null) {
            ...
            appendStringValue(stringBuilder, "&utmtci", ACRAConstants.DEFAULT_STRING_VALUE);
            appendStringValue(stringBuilder, "&utmtrg", ACRAConstants.DEFAULT_STRING_VALUE);
            appendStringValue(stringBuilder, "&utmtco", ACRAConstants.DEFAULT_STRING_VALUE);
        }
        stringBuilder.append("&utmac=").append(event.accountId);
        stringBuilder.append("&utmcc=").append(getEscapedCookieString(event, referrer));
        return stringBuilder.toString();
